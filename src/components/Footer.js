...
export const Twitter = ({ color = `rgba(255,255,255,0.7)`, url }) => (
  <Link
    to={url}
    css={css`
      color: ${color};
...
export const LinkedIn = ({ color = `rgba(255,255,255,0.7)`, url }) => (
  <Link
    to={url}
    css={css`
      margin-left: 20px;
...
export const GitHub = ({ color = `rgba(255,255,255,0.7)`, url }) => (
  <Link
    to={url}
    css={css`
      margin-left: 20px;
