...
- Logica duplicada entre diferentes componentes lo que dificulta la mantenibilidad del código o fomenta la creación de abstracciones aún más complejas
...
Por que hablo de un cambio de modelo mental?