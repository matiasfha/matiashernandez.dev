...
* **Intersection & Union type:** Permite crear tipos personalizados adecuados para el dominio particular.
  * Intersection: Permite unir varios tipos básicos en un solo tipo. Equivalente a un &ldquo;and&rdquo;
  * Union: Equivalente a un &ldquo;or&rdquo; Permite a la variable tomar uno de varios tipos
